...
const Weather = () => {
  ...
  const fetchWeather = async () => {
    if (!city.trim()) {
      toast({ title: t("common.error"), description: t("weather.enterCity"), variant: "destructive" });
      return;
    }
    setLoading(true);
    try {
      ...
      toast({ title: t("common.error"), description: error.message || "Failed to fetch weather data", variant: "destructive" });
    } finally {
      setLoading(false);
    }
  };
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="container max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">{t("weather.title")}</h1>
          ...
          {weather && (
            <div className="space-y-6">
              <Card className="p-8 shadow-lg bg-gradient-to-br from-blue-500 to-blue-600 text-white">
                ...
                <p className="text-blue-100">{t("weather.feelsLike")} {Math.round(weather.main.feels_like)}°C</p>
              </Card>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card className="p-6 shadow-lg">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-muted-foreground">{t("weather.windSpeed")}</span>
                  </div>
                ...
                <Card className="p-6 shadow-lg">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-muted-foreground">{t("weather.pressure")}</span>
                  </div>
